...
export default async function TrocaController(
  ...
  const imagesTable = [
    ...
    {id: '6', tipo: tiposMock[5], url: 'https://adrenaline.com.br/uploads/chamadas/amd_vai_continuar_usando_silicio_chamada.jpg'}
    
  ] 
  if (req.method === "GET") {
    res.status(200).json(imagesTable.find(el => el.id === req.query.imgid));
  }
}
