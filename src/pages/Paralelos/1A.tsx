            ...
            <Layout titulo='Metais Pesados' subtitulo='Gabriel Saliba, Kenzo Higashi, laura Lobato, Rafael nassau e Renata Passos' className='dark:text-white'>
                <div className="mt-20 flex flex-col md:flex-row">
                    <div className="flex flex-col">
                        <h1 className="text-[40px] font-bold">O QUE SÃO METAIS PESADOS?</h1>
                    ...
                    <img className="md:w-[25%] w-full mt-15" src='../../../m.jpg' alt="Imagem" />
                </div>

                <div className="mt-20 flex flex-col md:flex-row">
                    <div className="flex flex-col">
                        <h1 className="text-[40px] font-bold">MERCÚRIO</h1>
                        <p className="text-[20px]">
                    ...
                    <img className="md:w-[25%] w-full mt-15" src='../../../MetalPesado.jpg' alt="Imagem" />
                </div>

                <div className="mt-20 flex flex-col md:flex-row">
                    <div className="flex flex-col">
                        <h1 className="text-[40px] font-bold">CHUMBO</h1>
                        <p className="text-[20px]">
                        ...
                        <img src="../../../TabelaChumbo.png" className='md:w-2/6 w-full' alt="" />
                    </div>
                    <img className="md:w-[25%] w-full mt-15" src='../../../Cumbo.jpg' alt="Imagem" />

                </div>

                <div className="mt-20 flex flex-col md:flex-row">
                    <div className="flex flex-col">
                        <h1 className="text-[40px] font-bold">CÁDMIO</h1>
                    ...
                    <img className="md:w-[25%] w-full mt-15" src='../../../Cadmium-crystal_bar.jpg' alt="Imagem" />
                </div>
            </Layout>
        </div>
    )
